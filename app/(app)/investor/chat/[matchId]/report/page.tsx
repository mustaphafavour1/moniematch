        ...
        {done ? (
          <div style={{ textAlign: 'center', paddingTop: 60 }}>
            <div style={{
              ...
              <Icon name="check" size={28} color="var(--ink)" />
            </div>
          ...
          <>
                ...
                {CATEGORIES.map(cat => (
                  <button
                    ...
                    style={{
                      ...
                      borderColor: category === cat.value ? 'var(--ink)' : 'var(--line)',
                      background: category === cat.value ? 'var(--ink)' : 'var(--bone)',
            ...
            <button
              ...
              style={{
                ...
                background: canSubmit ? 'var(--ink)' : 'var(--linen)',
