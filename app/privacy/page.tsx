...
const PRIVACY_SECTIONS = [
  ...
  { title: '12. Contact Us', body: 'For any questions about this Privacy Policy or our data practices, please contact us at:<br/><br/><strong>MonieMatch Technologies Ltd</strong><br/>Email: <a href="mailto:admin@moniematch.com" style="color:var(--amber)">admin@moniematch.com</a><br/>Lagos, Nigeria' },
]
